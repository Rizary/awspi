...
/* package ghcjs-dom-jsaddle-0.7.0.3 */
#define VERSION_ghcjs_dom_jsaddle "0.7.0.3"
#define MIN_VERSION_ghcjs_dom_jsaddle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  7 || \
  (major1) == 0 && (major2) == 7 && (minor) <= 0)

/* package jsaddle-dom-0.7.2.0 */
#define VERSION_jsaddle_dom "0.7.2.0"
...
#define CURRENT_COMPONENT_ID "ghcjs-dom-jsaddle-0.7.0.3-inplace"

#define CURRENT_PACKAGE_KEY "ghcjs-dom-jsaddle-0.7.0.3-inplace"
