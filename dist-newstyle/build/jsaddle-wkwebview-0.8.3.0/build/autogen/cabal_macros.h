...
/* package jsaddle-wkwebview-0.8.3.0 */
#define VERSION_jsaddle_wkwebview "0.8.3.0"
#define MIN_VERSION_jsaddle_wkwebview(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  8 || \
...
#define CURRENT_COMPONENT_ID "jsaddle-wkwebview-0.8.3.0-inplace"

#define CURRENT_PACKAGE_KEY "jsaddle-wkwebview-0.8.3.0-inplace"
