...
/* package th-orphans-0.13.3 */
#define VERSION_th_orphans "0.13.3"
...
#define VERSION_th_lift_instances "0.1.11"
#define MIN_VERSION_th_lift_instances(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 11)

/* package th-reify-many-0.1.6 */
#define VERSION_th_reify_many "0.1.6"
...
#define CURRENT_COMPONENT_ID "th-orphans-0.13.3-inplace"

#define CURRENT_PACKAGE_KEY "th-orphans-0.13.3-inplace"
