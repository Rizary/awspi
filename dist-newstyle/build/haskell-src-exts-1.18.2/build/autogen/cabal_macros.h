...
/* package cpphs-1.20.4 */
#define VERSION_cpphs "1.20.4"
...
#define CURRENT_COMPONENT_ID "haskell-src-exts-1.18.2-inplace"

#define CURRENT_PACKAGE_KEY "haskell-src-exts-1.18.2-inplace"
